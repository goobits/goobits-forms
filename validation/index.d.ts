 ...
 * ```
 */
export declare function createValidationSchemaForCategory(config: ValidationConfig, category: string): z.ZodObject<any>;
/**
 ...
 * ```
 */
export declare function getValidatorForCategory(config: ValidationConfig, category: string): ReturnType<typeof zod4>;
/**
 ...
 * ```
 */
export declare function getValidationClasses(hasError: boolean, isTouched: boolean, value?: any): string;
/**
 ...
 * ```
 */
export declare function createDebouncedValidator<T extends (...args: any[]) => any>(validateFn: T, delay?: number): DebouncedValidator<T>;
/**
 ...
 * ```
 */
export declare function hasValidationErrors(errors: ValidationErrors): boolean;
/**
 ...
 * ```
 */
export declare function clearFieldError(errors: ValidationErrors, field: string): ValidationErrors;
