<script lang="ts">
  ...
  import type { TooltipPosition, TooltipState } from './tooltip.types.js';
  ...
  const tooltipClasses = $derived(() => {
    ...
    return [block, positionModifier, directionModifier, stateModifier, noTransitionModifier, customClasses].filter(Boolean).join(' ');
  });
...
.tooltip--direction-rtl.tooltip--position-left:not(.tooltip--state-visible):not(.tooltip--state-appearing) {
  transform: scale(0.95) translateX(calc(-1 * var(--space-2)));
}

.tooltip--direction-rtl.tooltip--position-right:not(.tooltip--state-visible):not(.tooltip--state-appearing) {
  transform: scale(0.95) translateX(var(--space-2));
}
...
.tooltip--position-top:not(.tooltip--state-visible):not(.tooltip--state-appearing) .tooltip__arrow--position-bottom {
  transform: rotate(45deg) scale(0.8) translateY(calc(-1 * var(--space-1)));
}

.tooltip--position-bottom:not(.tooltip--state-visible):not(.tooltip--state-appearing) .tooltip__arrow--position-top {
  transform: rotate(45deg) scale(0.8) translateY(var(--space-1));
}

.tooltip--position-left:not(.tooltip--state-visible):not(.tooltip--state-appearing) .tooltip__arrow--position-right {
  transform: rotate(45deg) scale(0.8) translateX(calc(-1 * var(--space-1)));
}

.tooltip--position-right:not(.tooltip--state-visible):not(.tooltip--state-appearing) .tooltip__arrow--position-left {
