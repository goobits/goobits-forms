 ...
 */
export type ErrorHandler = (error: Error, context: { data: Record<string, any>; slug: string }) => Promise<ActionResult | null>;
  ...
  async function handleSubmission({
    ...
    try {
      ...
      try {
        ...
        let submissionHandler: ((data: Record<string, any>, category: string) => Promise<void>) | undefined;
