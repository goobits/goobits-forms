 ...
 * ```
 */
export function validateRecaptchaOptions(options) {
 ...
 * ```
 */
export async function getRecaptchaDetails(token, options = {}) {
 ...
 * ```
 */
export function isRecaptchaApiResponse(obj) {
    return (obj &&
        typeof obj === 'object' &&
 ...
 * ```
 */
export function createRecaptchaMiddleware(options = {}) {
    const verifier = createRecaptchaVerifier(options);
    return async (token, action) => {
        try {
