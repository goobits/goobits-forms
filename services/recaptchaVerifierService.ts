 ...
 * ```
 */
export function createRecaptchaVerifier(config: RecaptchaVerificationOptions = {}): RecaptchaVerifier {
 ...
 * ```
 */
export function getDefaultRecaptchaVerifier(options: RecaptchaVerificationOptions = {}): RecaptchaVerifier {
