...
import type { SES, SESClientConfig } from '@aws-sdk/client-ses';
...
export class EmailProvider {
   ...
   * ```
   */
  async sendEmail(_to: string, _subject: string, _bodyHtml: string, _bodyText?: string): Promise<EmailResult> {
